...
def KeystrokeMain(client):
		...
		prs = Button(Stroke, text = "In phím",font = "Helvetica 10 bold",bg = "#CDB38B", padx = 25, pady = 20,command = Printkey).grid(row = 2,column = 2)
		delete = Button(Stroke, text = "Xóa", font = "Helvetica 10 bold", bg = "#8B795E",padx = 25, pady = 20,command = Deletekey).grid(row = 2,column = 3)
...
#		# along with action
	...
	def takepicture(self, client): #Chụp màn hình
		...
		self.cap = Button(self.Screenshot,text="Chụp", bg = "#008080", font = "Helvetica 10 bold",width=105,height=3,borderwidth=5,command = ReceivePicture, bd = 5, activebackground='#F4A460') #Nút chụp hình
		self.cap.grid(row=1,column=0)
		self.Save = Button(self.Screenshot,text="Lưu",bg = "#FFCC99",font = "Helvetica 10 bold",width=10,height=30,borderwidth=5,command=SavePicture, bd = 5, activebackground='#F4A460')#Nút luu ảnh
	...
	def apprunning(self, client):
		...
		Xoa = Button(self.app, text =  "Xóa",bg = "#00CDCD", font = "Helvetica 10 bold",padx = 30, pady = 20, command = XoaTask, bd = 5, activebackground='#F4A460').grid(row = 0, column = 2, padx = 10)
	...
	def processrunning(self, client):
		try:
			...
			Xoa = Button(self.process, text =  "Xóa", bg = "#4EEE94",font = "Helvetica 10 bold", padx = 30, pady = 20, command = XoaTask, bd = 5, activebackground='#F4A460').grid(row = 0, column = 2, padx = 0)
	...
	def control(self, client):
		...
		self.shut = Button(self.top,text ="Tắt máy", bg = "#CD6839", width =19, height =5, font=('Helvetica 10 bold'), command = (lambda : self.shutdown(client)), bd = 5, activebackground='#F4A460')
		self.shut.grid(row = 2, column =1, columnspan =2, rowspan =2)
		self.capture = Button(self.top, text ="Chụp màn hình",bg = "#EEA2AD", width =16, height =5, font=('Helvetica 10 bold'), command = (lambda : self.takepicture(client)), bd = 5, activebackground='#F4A460')
		self.capture.grid(row = 2, column =3, columnspan =2, rowspan =2)
		self.fix =Button(self.top, text="Sửa registry",bg = "#8B6969", width =37, font=('Helvetica 10 bold'), command = (lambda : self.fixregistry(client)), bd = 5, activebackground='#F4A460')
		...
		self.escape = Button(self.top, text ="Thoát",bg = "#8B7B8B", width =11,font=('Helvetica 10 bold'), command = (lambda : self.exist(client)), bd = 5, activebackground='#F4A460')
	...
	def receive(self, client):
		while True:
			try:
				messagebox.showinfo(" Success ", "Kết nối đến server thành công")
	...
	def goAhead(self, HOST):
		...
		try: 
			...
			messagebox.showinfo(" !Warning ", "Chưa kết nối đến server") #Kiểm tra lỗi kết nối bằng cách dùng try và except
